...
<body>
        ...
        <div class="main">
            ...
            <div id="myModalConf" class="modal">
                <div class="modal-contentConf" style="border-radius: 1%;">
                    ...
                    <h3 style="margin: 0% 0% 2% 0%;">Desejas confirmar a operação?</h3>

                    <div style="display: flex; margin-left: 33.5%; margin-top: 20px;">
                        <button id="btnY" class="btn11">Sim</button>
                        <button onclick="cancelar()" id="btnN" class="btn22">Não</button>
                    </div>
                </div>
            </div>
            ...
            <div id="myModal" class="modal">
                <div class="modal-content" style="border-radius: 1%;">
                    <span onclick="cancelar()" class="close">&times;</span>
                    <h1 style="margin: 0% 0% 2% 0%;">Adcionar conteudo</h1>
                    <hr style="width: 97%; margin: 0;">

                    <div id="pef">
                        <img src="img/icons/undraw_male_avatar_323b.svg" alt="Foto Perfil" style="width: 50px; height: 50px;" id="fotoperfil">
                        <p style="margin: 5px 0px 0px 10px">João Carvalho</p>
                    </div>
                    ...
                    <form id="formulario" style="padding: 0% 7%;">
                        <div style="display: flex;  margin-top: 20px; justify-content: space-between;">
                            <div style="width: 100%;">
                                ...
                                <input required type="text" id="titulo" class="inputsAdd" value="Titulo do Conteudo">
                            </div>
                        </div>
                        ...
                        <div style="display: flex;  margin-top: 20px; justify-content: space-between;">
                            <div style="width: 49%;">
                                ...
                                <input required type="text" id="produtor" class="inputsAdd" value="Produtor do Conteudo">
                            </div>
                            <div style="width: 49%;">
                                <p style="margin: 0;">Autor</p>
                                <input required type="text" id="autor" class="inputsAdd" value="Autor do Conteudo">
                            </div>
                        </div>
                        ...
                        <div style="display: flex;  margin-top: 20px; justify-content: space-between;">
                            <div>
                                ...
                                <select name="tipo_c" id="tipo_c" required class="tipo_c">
                                    <option value="historiAntiga" selected>História Antiga</option>
                                    <option value="andedotas">Anedotas</option>
                                    <option value="proverbios">Provérbios</option>
                                    <option value="advinhas">Advinhas</option>
                                    <option value="andedotas">Andetodas</option>
                                </select>
                            </div>

                            <div style="width: 49%;">
                                <p style="margin: 0;">Data Produção</p>
                                <input required type="date" name="" id="dataNascimento" class="inputsAdd">
                            </div>
                        </div>
                        <div>
                            <p>Adcione o ficheiro</p>
                            <input type="file" id="avatar" name="avatar" accept="image/png, image/jpeg, image/jsp">
                        </div>

                        <div style="display: flex; justify-content: flex-end; margin-top: 20px;">
                            <button id="btn11" class="btnPositive" type="submit" onclick="guardar()">Publicar
                                Conteudo</button>
            ...
            <div style="display: flex; justify-content: space-between;">
                <div class="tipo">
                    ...
                    <a href="TelaInicialAudio.php"><img src="img/icons/MusicNote_Orange.svg" alt="" width="40" height="40" class="ttc"></a>
                </div>
                <div class="botoes">
                    <button class="btn" id="btnGerir" onclick="location.href='GerirConteudo.php'">Gerir
                        Conteúdos</button>
            ...
            $tipoFiltro = array_key_exists('tipoLista1', $_POST) ? trim($_POST['tipoLista1']) : '';
            ...
            if ($audio == 1) {
                ...
                left JOIN utilizador AS uti_publ ON uti_publ.ID_uti=cont_form.Id_publicador
                left JOIN utilizador AS uti_aval ON uti_aval.ID_uti=cont_form.Id_avaliador
                where form.tipo='Áudio' and cont_form.Estado = 1
                order by cont_form.Data_publicacao desc; ";
                $audio = 0;
                $result = mysqli_query($conn, $sql);
    ...
    <script>
        ...
        window.onclick = function(event) {
            if (event.target == modal || event.target == modalConf || event.target == modalEdit) {
                modal.style.display = "none";
                modalConf.style.display = "none";
